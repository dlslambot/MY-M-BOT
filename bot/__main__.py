...
def start(update, context):
    ...
    buttons.buildbutton("Official Group", "https://t.me/+cvPJqSAyHuNmNzk1")
...
'''
        ...
        sendMarkup('Not An Authorized User, Join The Official Group To Use Me', context.bot, update.message, reply_markup)
